...
export const needsReviewReport: PreflightReport = {
  ...
  release_package: {
    video: { state: "PRESENT_VALID", detail: "1280×720 · 12:00" },
    thumbnail: { state: "NOT_REQUIRED", detail: "Not supplied" },
    captions: { state: "NOT_REQUIRED", detail: "Not supplied" },
    title: { state: "PRESENT_VALID", detail: "Supplied" },
    description: { state: "PRESENT_VALID", detail: "Supplied" },
    chapters: { state: "NOT_REQUIRED", detail: "Not supplied" },
    release_contract: { state: "NOT_REQUIRED", detail: "Not supplied" },
