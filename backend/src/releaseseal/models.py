...
from releaseseal.release_models import ReleaseBrief, ReleaseBriefSource
from releaseseal.release_contract import ReleaseContract, ReleaseContractEvaluation
from releaseseal.release_evidence import AudioEvidenceState
from releaseseal.release_plan import ReleasePlan
from releaseseal.release_package import ReleasePackageSummary, empty_release_package_summary
...
class PreflightReport(BaseModel):
    """Unified, explainable ReleaseSeal scan report."""
...
class PreflightCapabilities(BaseModel):
    ...
    local_caption_generation_available: bool
