...
from releaseseal.ai_review import AIReviewError, GeminiVideoReviewer, _classify_provider_error
from releaseseal.config import AIReviewConfig, RevisionSemanticReviewConfig
from releaseseal.revision_check_models import RevisionCheckReport, RevisionRequest, RevisionRequestStatus
from releaseseal.revision_evidence import RevisionEvidenceError, plan_revision_evidence, render_revision_evidence
from releaseseal.revision_semantic_models import (
...
class RevisionSemanticReviewService:
    ...
    def _review_one(self, previous: Path, revised: Path, report: RevisionCheckReport, request: RevisionRequest):
        try:
            ...
            with TemporaryDirectory(prefix="releaseseal-semantic-evidence-") as directory:
