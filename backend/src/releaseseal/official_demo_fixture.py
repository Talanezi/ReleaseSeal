...
from releaseseal.promise_fixture import _canvas, _draw_text, _fill_rect, _write_png, _write_ppm
...
def generate_official_demo(
    ...
    *,
    ...
    video = output / "releaseseal-official-demo.mp4"
    thumbnail = output / "releaseseal-official-thumbnail.png"
    captions = output / "releaseseal-official-captions.srt"
    title = output / "releaseseal-official-title.txt"
    description = output / "releaseseal-official-description.txt"

    with tempfile.TemporaryDirectory(prefix="releaseseal-official-") as temporary:
