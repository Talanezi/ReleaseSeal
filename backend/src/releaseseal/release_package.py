...
from releaseseal.thumbnail_assurance import ThumbnailAssuranceReport, assurance_findings
...
def evaluate_release_package(
    *,
    ...
    from releaseseal.models import CheckResult, Finding, FindingSeverity, FindingStatus
    from releaseseal.rules import parse_chapters
